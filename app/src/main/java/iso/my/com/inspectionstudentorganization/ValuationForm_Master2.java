...
public class ValuationForm_Master2 extends AppCompatActivity {

    ImageButton back;
    WebView mwebView;
    String url = "http://sns.tehranedu.ir/regions/eva3.aspx";
    int id;
    ...
    public void setListeners() {
        ...
        final ValuationForm_Master2.MyJavaScriptInterface myJavaScriptInterface
                = new ValuationForm_Master2.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(ValuationForm_Master2.this);
