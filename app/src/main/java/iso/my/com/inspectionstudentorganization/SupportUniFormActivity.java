...
public class SupportUniFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_support_uni_form);
    ...
    public void setListeners() {
        ...
        final SupportUniFormActivity.MyJavaScriptInterface myJavaScriptInterface
                = new SupportUniFormActivity.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(SupportUniFormActivity.this);
