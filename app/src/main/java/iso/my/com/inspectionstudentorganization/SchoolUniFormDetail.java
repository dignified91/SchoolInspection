...
public class SchoolUniFormDetail extends AppCompatActivity implements OnMapReadyCallback, LocationListener {

    private static final int PERMISSION_REQ_CODE = 1234;
    public Double lat, lon;
    List<AsyncTask> tasks = new ArrayList<>();

    String URI_LOCATION = "http://sns.tehranedu.ir/ws/RecordStatusLebas.aspx";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.school_uni_form_detail);
...
//                    new LatLng(location.getLatitude(), location.getLongitude()), 13.5f));
    ...
    public void setlocation() {
        ...
        new SchoolUniFormDetail.MyTask().execute(requestData);
    ...
    private void onClickBtnStart() {
        ...
        starturl = "http://sns.tehranedu.ir/ws/RecordStatuslebas.aspx"
    ...
    public void afterStart() {
        ...
        if (startIns.isStarterd()) {
            Intent intent = new Intent(this, CompleteInspectionUniForm.class);
            startActivity(intent);
