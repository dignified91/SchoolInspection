...
public class SchoolLocation extends AppCompatActivity implements OnMapReadyCallback, LocationListener {

    private String URL_SCH = "http://sns.tehranedu.ir/ws/Inspectorschool.aspx";
    ImageButton back;
    GoogleMap mMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shools_location);
