...
public class SendError extends ActivityEnhanced {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_error);
        set();
        loadtypeer();
            ...
            for (int i = 0; i < response.length(); i++) {
                try {
                    ...
                    if (jsonObject.optString("status").equals("0")) {
                        ...
                        Intent in = new Intent(getApplicationContext(), Completeinspection.class);
                        startActivity(in);
    ...
    private void loadtypeer() {
        ...
        ertype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (typeId == 2) {
                    String durl = URI_TITLE + "?type=" + typeId;
                    geterrorspinnerdata(durl);
                ...
                if (typeId == 3) {
                    String surl = URI_TITLE + "?type=" + typeId;
                    geterrorspinnerdata(surl);
                    spt.clear();
                    errorspinner.setAdapter(null);
                    Log.i("nasnaas", surl);
                }
                if (typeId == 4) {
                    String surl = URI_TITLE + "?type=" + "1499";
                    geterrorspinnerdata(surl);
                    spt.clear();
                    errorspinner.setAdapter(null);
                    Log.i("nasnaas", surl);
...
//    },Url
    ...
    private void showselectpopup() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SendError.this);
