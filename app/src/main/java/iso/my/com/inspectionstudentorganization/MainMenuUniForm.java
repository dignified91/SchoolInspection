...
import iso.my.com.inspectionstudentorganization.SchoolUniFormList.SchoolsAdapter;
import iso.my.com.inspectionstudentorganization.SchoolUniFormList.SchoolsUtils;
import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;

public class MainMenuUniForm extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_menu_uni_form);
        pref = getSharedPreferences("myprefs", MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putString("ppp", "mainuniform");
        editor.apply();
    ...
    private void cardviewclick() {
        ...
        {
            Intent i = new Intent(getApplicationContext(), SupportUniFormActivity.class);
            startActivity(i);
        };
        ...
        {
            Intent i = new Intent(getApplicationContext(), IdentifyUniFormCard.class);
