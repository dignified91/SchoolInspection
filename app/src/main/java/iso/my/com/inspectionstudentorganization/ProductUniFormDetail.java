...
import iso.my.com.inspectionstudentorganization.ProUniFormDetail.ProDetailUtils;
import iso.my.com.inspectionstudentorganization.ProUniFormDetail.ProductDetAdapter;
import iso.my.com.inspectionstudentorganization.SchoolsDetail.StartIns;
import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;

public class ProductUniFormDetail extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    String URI_PRODET = "http://sns.tehranedu.ir/ws/Inspectorlebas.aspx";
    ...
    public int id;
    List<ProFormDetail> schoolsdetail;
    private ProductDetAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.prouniform_detail);
...
//                    new LatLng(location.getLatitude(), location.getLongitude()), 13.5f));
    ...
    private void getLocations() {
        ...
        String url = URI_PRODET + "?id=" + getpass();
    ...
    private void onClickBtnStart() {
        ...
        starturl = "http://sns.tehranedu.ir/ws/RecordStatustolid.aspx"
    ...
    public void afterStart() {
        ...
        if (startIns.isStarterd()) {
            Intent intent = new Intent(this, CompleteinspectionProduct.class);
            startActivity(intent);
    ...
    private void getdet() {
        ...
        System.out.println(URI_PRODET + "?id=" + id);
        JsonArrayRequest request = new JsonArrayRequest(
                URI_PRODET + "?id=" + id,
                response ->
                {
                    schoolsdetail = ProDetailUtils.jsonArrayToDetailPro(response);
                    updateDisplay();
    ...
    private void updateDisplay() {
        ...
        adapter = new ProductDetAdapter(
                this, R.layout.detail_pro_list_item, schoolsdetail);
