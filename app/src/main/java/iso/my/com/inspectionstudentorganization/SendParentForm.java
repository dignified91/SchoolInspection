...
public class SendParentForm extends AppCompatActivity {

    ImageButton back;
    WebView mwebView;
    String url = "http://sns.tehranedu.ir/regions/inspectorlebas_mob2.aspx";
    int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_parent_form);
    ...
    private void set() {
        ...
        toolbar_title.setText(R.string.toolbarsendparentform);
    ...
    public void setListeners() {
        ...
        final SendParentForm.MyJavaScriptInterface myJavaScriptInterface
                = new SendParentForm.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(SendParentForm.this);
