...
public class CompleteinspectionProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complete_inspection_product);
    ...
    private void set() {
        ...
        View.OnClickListener onClickSendForm = view -> {
            ...
            Intent i = new Intent(getApplicationContext(), SendProForm.class);
            startActivity(i);
        };
        ...
        View.OnClickListener onClickSendError = view -> {
            ...
            Intent i = new Intent(getApplicationContext(), SendErrorProUniForm.class);
            startActivity(i);
        };
        ...
        View.OnClickListener onClickEndIns = view -> {
            ...
            endurl = "http://sns.tehranedu.ir/ws/RecordStatustolid.aspx"
