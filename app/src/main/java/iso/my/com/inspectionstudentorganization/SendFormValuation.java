...
public class SendFormValuation extends AppCompatActivity {

    ImageButton back;
    WebView mwebView;
    String url = "http://sns.tehranedu.ir/regions/inspectorbuf_mob.aspx";
    int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_form_valuation);
    ...
    public void setListeners() {
        ...
        final SendFormValuation.MyJavaScriptInterface myJavaScriptInterface
                = new SendFormValuation.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(SendFormValuation.this);
