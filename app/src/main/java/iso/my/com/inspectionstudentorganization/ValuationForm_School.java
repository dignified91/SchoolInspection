...
public class ValuationForm_School extends AppCompatActivity {

    ImageButton back;
    WebView mwebView;
    String url = "http://sns.tehranedu.ir/regions/eva1.aspx";
    int id;
    ...
    public void setListeners() {
        ...
        final ValuationForm_School.MyJavaScriptInterface myJavaScriptInterface
                = new ValuationForm_School.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(ValuationForm_School.this);
