...
public class SendErrorUniForm extends ActivityEnhanced {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_error_uni_form);
        set();
        loadtypeer();
    ...
    private void set() {
        ...
        sendphoto = findViewById(R.id.senderror);
            ...
            for (int i = 0; i < response.length(); i++) {
                try {
                    ...
                    if (jsonObject.optString("status").equals("0")) {
                        ...
                        Intent in = new Intent(getApplicationContext(), CompleteInspectionUniForm.class);
                        startActivity(in);
    ...
    private void loadtypeer() {
        ...
        ArrayAdapter eradapter = new ArrayAdapter(SendErrorUniForm.this, android.R.layout.simple_spinner_dropdown_item, type);
        ...
        ertype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                // your code here
                typeId = ertype.getSelectedItemPosition() + 4;
                if (typeId == 4) {
...
//    },Url
    ...
    private void showselectpopup() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SendErrorUniForm.this);
