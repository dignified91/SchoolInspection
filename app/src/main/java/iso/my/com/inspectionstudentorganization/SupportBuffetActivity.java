...
public class SupportBuffetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.support_buffet);
    ...
    public void setListeners() {
        ...
        final SupportBuffetActivity.MyJavaScriptInterface myJavaScriptInterface
                = new SupportBuffetActivity.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(SupportBuffetActivity.this);
