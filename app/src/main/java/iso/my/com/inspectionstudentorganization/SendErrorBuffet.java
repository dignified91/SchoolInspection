...
public class SendErrorBuffet extends ActivityEnhanced {
    ...
    Button upload, SendErrorBuffet,sendphoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_error_buffet);
        set();
        loadtypeer();
            ...
            for (int i = 0; i < response.length(); i++) {
                try {
                    ...
                    if (jsonObject.optString("status").equals("0")) {
                        ...
                        Intent in = new Intent(getApplicationContext(), CompleteinspectionBuffet.class);
                        startActivity(in);
    ...
    private void loadtypeer() {
        ...
        ertype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                // your code here
                typeId = ertype.getSelectedItemPosition() + 8;
                if (typeId == 8) {
...
//                    error.getMessage(), Toast.LENGTH_SHORT).show();
                        ...
                        + "&des=" + URLEncoder.encode(desc), response ->
        {
            ...
            for (int i = 0; i < response.length(); i++) {
                try {
                    ...
                    if (jsonObject.optString("status").equals("0")) {
                        // Toast.makeText(SendErrorBuffet.class, "ثبت اطلاعات با مشکل مواجه شد ، لطفا دوباره تلاش کنید.", Toast.LENGTH_LONG).show();
    ...
    private void showselectpopup() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SendErrorBuffet.this);
