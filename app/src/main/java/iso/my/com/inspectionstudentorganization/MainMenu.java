...
import iso.my.com.inspectionstudentorganization.SchoolList.SchoolsAdapter;
import iso.my.com.inspectionstudentorganization.SchoolList.SchoolsUtils;
import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;

public class MainMenu extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    //test schoollist id=1;
    public static final String URI_SCHLIST = "http://sns.tehranedu.ir/ws/InspectorSchoolsList.aspx";
    public static final String URI_LOG = "http://sns.tehranedu.ir/ws/InspectorLogin.aspx";
    TextView tv_name;
    ImageButton exit, iconsupport, iconcard;
    ImageButton school_not_submit;
    LinearLayout lysupp, lycard;
    SharedPreferences pref;
    DriverData driverData = null;
    String name, family, mobile, region, pcode, image, desc, schname, schid, status,gender,type;
    Boolean st;
    int id;
    List<School> schools;
...
//    }
    ...
    private void set() {
        ...
        school_not_submit = findViewById(R.id.suberrorsch);
        school_not_submit.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), NonRegSchool.class);
...
//                startActivity(intent);
    ...
    private void cardviewclick() {
        ...
        {
            Intent i = new Intent(getApplicationContext(), IdentifyCard.class);
    ...
    private void ShowInsData(String url) {
        ...
        String dataurl = URI_SCHLIST + "?id=" + id;
    ...
    private void getschools() {
        System.out.println(URI_SCHLIST + "?id=" + id);
