...
public class SchoolDetail extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
...
//                    new LatLng(location.getLatitude(), location.getLongitude()), 13.5f));
    ...
    private void onClickBtnStart() {
        ...
        starturl = "http://sns.tehranedu.ir/ws/RecordStatusInspector.aspx"
    ...
    public void afterStart() {
        ...
        if (startIns.isStarterd()) {
            Intent intent = new Intent(this, Completeinspection.class);
            startActivity(intent);
