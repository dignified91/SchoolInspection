...
public class ValuationForm_Master1 extends AppCompatActivity {

    ImageButton back;
    WebView mwebView;
    String url = "http://sns.tehranedu.ir/regions/eva2.aspx";
    int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.valuation_form_school);
    ...
    public void setListeners() {
        ...
        final ValuationForm_Master1.MyJavaScriptInterface myJavaScriptInterface
                = new ValuationForm_Master1.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(ValuationForm_Master1.this);
