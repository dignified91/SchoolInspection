...
public class SupportProUniFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_support_pro_uni_form);
    ...
    public void setListeners() {
        ...
        final SupportProUniFormActivity.MyJavaScriptInterface myJavaScriptInterface
                = new SupportProUniFormActivity.MyJavaScriptInterface(this);
    ...
    public class MyJavaScriptInterface {
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(SupportProUniFormActivity.this);
